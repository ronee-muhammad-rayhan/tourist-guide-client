...
const MyProfile = () => {
    const userMongoDb = useLoaderData();
    const { user } = useAuth();
    return (
        <div>
            <div>
                <div className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100">
                    <img src={`${user?.photoURL}`} alt={`Photo of ${user?.displayName}`} className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
