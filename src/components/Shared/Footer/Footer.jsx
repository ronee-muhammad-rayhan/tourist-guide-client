                    ...
                    <div className="grid grid-cols-12">
                        <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
                            <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start">
                                ...
                                <span className="self-center text-2xl font-semibold">Tourist Guide</span>
                            </a>
                        </div>
                        <div className="col-span-6 text-center md:text-left md:col-span-3">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">News & Blogs</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Support Policy</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Office Location</a>
                                </li>
                            </ul>
                        </div>
                        <div className="col-span-6 text-center md:text-left md:col-span-3">
                            ...
                            <ul>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Tour Guide</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Tour Booking</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Customer Services</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Account SignUp</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Return/Exchange</a>
                                </li>
                            </ul>
                        </div>
                    </div>
