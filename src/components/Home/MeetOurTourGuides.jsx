...
const MeetOurTourGuides = () => {
    ...
    return (
        <div>
            meet our tour guides: {guides.length}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 py-10 gap-5">
                {
                    guides.map((guide, i) => {
                        return (
                            <div key={i} className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100">
                                <img src={`${guide?.photoURL}`} alt={`Photo of ${guide?.displayName}`} className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
                                <div className="space-y-4 text-center divide-y dark:divide-gray-700">
                                    <div className="my-2 space-y-1">
                                        <h2 className="text-xl font-semibold sm:text-2xl">{guide?.displayName}</h2>
                                        {/* <p className="px-5 text-xs sm:text-base dark:text-gray-400">{`${userMongoDb?.role || 'Programmer'} at Tourist Guide`}</p> */}
                                    </div>
                                    <div className="pt-4">
