...
const CallToAction = () => {
    return (
        <div className="w-full bg-gray-500" style={{ backgroundImage: `url('https://source.unsplash.com/random/640x480')`, backgroundPosition: 'center-center', backgroundBlendMode: 'multiply', backgroundSize: 'cover' }}>
            {/* <div className="w-full bg-gray-500" style="background-image: url('https://source.unsplash.com/random/640x480'); background-position: center center; background-blend-mode: multiply; background-size: cover;"> */}
